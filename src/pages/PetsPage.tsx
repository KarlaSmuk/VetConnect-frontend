                                        ...
                                        <Flex>
                                            {pet.photo && (
                                                <Avatar
                                                    ...
                                                    size={"lg"}
                                                    name={`${pet.name}`}
                                                    src={`https://lh3.googleusercontent.com/d/${pet.photo!}`}
                                                />
                                            )}
                                            ...
                                            {pet.status === PetStatus.LOST && (
                                                <Badge
                                                    ...
                                                    colorScheme="red"
                                                >
                                                    {pet.gender === "Muško" ? "Nestao" : "Nestala"}
                                                </Badge>
                                            )}
                                        </Flex>
                                        <Flex direction={"column"} gap={2}>
                                            {(currentUser?.vet || currentUser?.owner) &&
                                                pet.status === PetStatus.ALIVE && (
                                                    <Button
                                                        onClick={(e) =>
                                                            handlePetStatus(e, pet.id, PetStatus.LOST)
                                                        }
                                                        rightIcon={<EditIcon />}
                                                        colorScheme="red"
                                                        width={"100px"}
                                            ...
                                            {(currentUser?.vet || currentUser?.owner) &&
                                                pet.status === PetStatus.LOST && (
                                                    <Button
                                                        onClick={(e) =>
                                                            handlePetStatus(e, pet.id, PetStatus.ALIVE)
                                                        }
                                                        rightIcon={<EditIcon />}
                                                        colorScheme="green"
                                                        width={"100px"}
                                                        ...
                                                        size="sm"
                                                    >
                                                        {pet.gender === "Muško" ? "Pronađen" : "Pronađena"}
                                                    </Button>
                                                )}
                                            {currentUser?.vet && (
                                                <Button
                                                    onClick={(e) =>
                                                        handlePetStatus(e, pet.id, PetStatus.DECEASED)
                                                    }
                                    ...
                                    {currentUser?.owner && (
                                        ...
                                        >
                                            <Flex direction={"column"} alignItems={"flex-start"}>
                                                <FormControl>
                                                    <FormLabel mb="8px" fontSize="s">
                                                        Spremi sliku ljubimca:
                                                    </FormLabel>
                                                    <input
                                                        multiple={false}
                                                        type="file"
                                                        name="image"
                                                        accept="image/*"
                                                        onChange={(e) => handleImageInput(e, pet.id)}
                                                    />
